					...
					<div class="accordion" id="accordionExample">
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingOne">
								<button class="accordion-button" type="button"
									data-bs-toggle="collapse" data-bs-target="#collapseOne"
									aria-expanded="true" aria-controls="collapseOne">
									허니비는 어떤 사이트 인가요?</button>
							</h2>
							<div id="collapseOne" class="accordion-collapse collapse show"
								aria-labelledby="headingOne" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									<strong>허니비는 재능 거래 마켓</strong> 플랫폼으로서,
									자신이 가지고 있는 재능을 판매할 수 있는 사이트 입니다.
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingTwo">
								<button class="accordion-button collapsed" type="button"
									data-bs-toggle="collapse" data-bs-target="#collapseTwo"
									aria-expanded="false" aria-controls="collapseTwo">
									어떠한 재능이여도 상관 없는건가요?</button>
							</h2>
							<div id="collapseTwo" class="accordion-collapse collapse"
								aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									허니비는 자유롭게 자신의 재능을 판매할 수 있고,
									<strong>자신이 사소하다고 생각 하더라도</strong> 자유롭게 판매할 수 있습니다. 
								</div>
							</div>
						</div>
						<div class="accordion-item">
						...
						<div class="accordion-item">
							...
							<div id="collapsefour" class="accordion-collapse collapse"
								...
								data-bs-parent="#accordionExample">
								<div class="accordion-body">
									직거래/추가결제요구, 연락두절등 판매가 원활하지 않는 재능을 신고하게 되면 신고재능에 경고가 주어집니다. 
									 재능넷 사이트 고객센터 > 1:1 문의하기로 신고사유와 함께 자료를 보내주시면 확인하여 접수됩니다.
								</div>
							</div>
						</div>
						<div class="accordion-item">
							...
							<div id="collapsefive" class="accordion-collapse collapse"
								...
								data-bs-parent="#accordionExample">
								<div class="accordion-body">
									메인페이지에 있는 게이지는 기부 게이지며
									일정금액이 달성될 경우 기부하게 됩니다.
								</div>
							</div>
						</div>
					...
					<div class="accordion" id="accordionExample">
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingOne">
								<button class="accordion-button" type="button"
									data-bs-toggle="collapse" data-bs-target="#collapseOne"
									aria-expanded="true" aria-controls="collapseOne">
									허니비 마켓은 무엇인가요?</button>
							</h2>
							<div id="collapseOne" class="accordion-collapse collapse show"
								aria-labelledby="headingOne" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									<strong>허니비 사이트의 마켓</strong> 플랫폼으로서,
									각종 사이트의 상품을 판매합니다.
								</div>
							</div>
						</div>
						...
						<div class="accordion-item">
							...
							<div id="collapseTwo" class="accordion-collapse collapse"
								aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									판매된 금액은 사이트의 운영 및 여러가지에 이용되며,
									<strong>일정 금액은 기부</strong> 됩니다. 
								</div>
							</div>
						</div>
						<div class="accordion-item">
						...
						<div class="accordion-item">
							...
							<div id="collapsefour" class="accordion-collapse collapse"
								...
								data-bs-parent="#accordionExample">
								<div class="accordion-body">
									 아직 배송지 변경 기능을 구현하지 않았기 때문에
									혹시 변경요청이 있을 경우 아래의 번호로 전화해주시길 바랍니다.
											honey 서비스
