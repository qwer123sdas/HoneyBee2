						...
						<c:forEach items="${market.fileName }" var="file">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img
										src="${imageUrl }/market/${market.market_id }/${encodedFileName } class="
										d-block w-100" alt="...">
								</div>
							</div>
		...
		<div class="row">
			<div class="col">
				...
				<div class="space-between">
					...
					<div style="article-profile-left">
						<div style="top:15px"><strong>${market.memberId }</strong></div>
						<div style="bottom:15px"><strong>${market.inserted }</strong></div>
					<hr />		
					</div>
					</div>
				</div>
