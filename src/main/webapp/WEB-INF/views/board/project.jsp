...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="project" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="example" class="nav-item nav-link">Home</a>
            ...
            <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.5s">
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-6.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-5.jpg" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item third">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-4.jpg" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-3.jpg" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-2.jpg" alt="">
                        <div class="portfolio-btn">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item third">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid" src="${appRoot }/resources/webContents/img-600x400-1.jpg" alt="">
                        <div class="portfolio-btn">
